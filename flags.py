...
f.DEFINE_string("model_type", "mnemonic_reader",
                "Type of model to train. The model types are in models/model_types.py")
...
f.DEFINE_string("data_dir", "data", "Directory with word embeddings, vocab, and training/dev data.")
f.DEFINE_string("evaluation_dir", "evaluation_results", "Directory that stores the results of evaluating models.")
...
f.DEFINE_string("s3_bucket_name", "zippy-machine-learning", "The AWS S3 bucket to save models to.")
...
f.DEFINE_float("dropout", 0.2,
               "The amount of dropout to use. Should be between 0 (no dropout) and 1.0 (100% dropout).")
...
f.DEFINE_integer("dataset_buffer_size", 100,
                 "Size of the dataset buffer. See the Tensorflow Dataset API for details.")
f.DEFINE_boolean("use_fake_dataset", False, "Whether to use a synthetic dataset in order to debug the model.")
...
f.DEFINE_integer("max_search_span_range", 15,
                 "Maximum number of words in a predicted span; used to get a small boost in performance.")
f.DEFINE_boolean("use_word_in_question_feature", True,
                 "Whether to use the feature indicating for each word "
                 "in the context whether it is in the question")
f.DEFINE_boolean("use_word_similarity_feature", True, "Whether to use the feature indicating word similarity.")
f.DEFINE_boolean("use_character_data", True, "Whether to add character-level data to the inputs.")
f.DEFINE_integer("character_embedding_size", 30,
                 "Size of character embeddings. Only applicable if character-level data is enabled.")
