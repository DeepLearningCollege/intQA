...
def self_critic_rl(options, sq_dataset, example_start_pos_list, example_end_pos_list, data_index_iterator, qst_iterator, ce_loss):
    """
    ...
    for start_span_probs, end_span_probs in zip(example_start_pos_list, example_end_pos_list):
